...
Exploratory analysis figures exclude 2026 data unless a figure is explicitly labeled as current-season or final prediction. Modern descriptive figures use 2019-2025 data, historical figures use the SQLite historical dataset, and final prediction figures use the 2026 current-season state.
...
Project use: dataset description.
...
Project use: project background.
...
Project use: project background and historical context.
...
Project use: analysis of starting grid influence.
...
Project use: analysis of qualifying influence.
...
Project use: technical analysis of qualifying-to-race relationship.
...
Project use: historical-modern comparison.
...
Project use: race position-change analysis.
...
Project use: driver performance overview.
...
Project use: driver trend analysis.
...
Project use: driver trend comparison.
...
Project use: driver achievement analysis.
...
Project use: driver stability and consistency analysis.
...
Project use: racecraft and position-gain analysis.
...
Project use: constructor performance overview.
...
Project use: constructor trend analysis.
...
Project use: constructor competition analysis.
...
Project use: constructor achievement analysis.
...
Project use: team ranking evolution.
...
Project use: team efficiency analysis.
...
Project use: constructor race execution analysis.
...
Project use: circuit characteristic analysis.
...
Project use: circuit overtaking and race-flow analysis.
...
Project use: advanced circuit analysis.
...
Project use: technical indicator construction.
...
Project use: feature analysis and modeling motivation.
...
Project use: competitive balance analysis.
...
Project use: professional competition concentration metric.
...
Project use: pre-race feature effectiveness analysis.
...
Project use: race status and reliability analysis.

## Videos

Videos are tracked in Git as generated project outputs. They can also be regenerated by running `python animate_f1_points.py`.
...
Project use: dynamic team standings evolution.
...
Project use: long-term constructor dominance.
...
Project use: modern driver standings evolution.
...
Project use: machine learning model evaluation.
...
Project use: model interpretation and feature analysis.
...
Project use: robustness evaluation.
...
Project use: model performance comparison.
...
Project use: model discrimination ability.
...
Project use: race-level prediction evaluation.
...
Project use: final model comparison.
...
Project use: comprehensive model evaluation.
...
Project use: robustness and generalization evaluation.
...
Project use: advanced model comparison.
...
Project use: race-level ranking evaluation.
...
Project use: advanced ranking model evaluation.
...
Project use: final model selection and overall model evaluation.
...
Project use: championship-simulation preparation.
...
Project use: expected-points model evaluation.
...
Project use: regression model diagnostic.
...
Project use: race-level Top 10 evaluation.
...
Project use: regression error diagnosis.
...
Project use: probability calibration and model reliability diagnosis.
...
Project use: F1 points-rule post-processing and championship-simulation preparation.
...
Project use: race-level prediction-quality diagnosis.
...
Project use: model robustness and temporal validation.
...
Project use: model-improvement experiment and limitation discussion.
...
Project use: Top 10 model interpretation.
...
Project use: points model interpretation.
...
Project use: F1 scoring-rule post-processing and model selection for season simulation.
...
Project use: probability calibration before season-level simulation.
...
Project use: uncertainty modeling and championship-prediction preparation.
...
Project use: constructor championship uncertainty analysis.
...
Project use: probabilistic championship prediction method.
...
Project use: technical justification for feeding projected future-race outcomes into later 2026 championship-prediction rolling features.
...
Project use: justification for handling drivers with limited historical samples but strong current-season form.
...
Project use: technical justification for adding S4 and S5 as season-level sensitivity scenarios.
...
Project use: final 2026 driver championship prediction.
...
Project use: final 2026 constructor championship prediction.
...
Project use: final driver standings uncertainty analysis.
...
Project use: final constructor standings uncertainty analysis.
...
Project use: robustness comparison of final championship predictions under different high-performing model choices.
...
Project use: detailed per-model comparison of champion probabilities and final-points uncertainty.
